...
import { Search, Film, Tv, LogOut, Menu, X, User, Sun, Moon, Play } from 'lucide-react';
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          <form onSubmit={handleSearchSubmit} className="relative">
            <input
              ...
              className="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-full py-2 px-4 pl-10 text-sm focus:outline-none focus:ring-2 focus:ring-[#E50914] focus:border-transparent text-gray-900 dark:text-white w-[180px] transition-all duration-200 focus:w-[220px] placeholder-gray-500 dark:placeholder-gray-400"
            />
          ...
          <div className="p-4 space-y-4">
            <form onSubmit={handleSearchSubmit} className="relative">
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-full py-2 px-4 pl-10 text-sm focus:outline-none focus:ring-2 focus:ring-[#E50914] focus:border-transparent text-gray-900 dark:text-white w-full placeholder-gray-500 dark:placeholder-gray-400"
              />
              <Search size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-400" />
            </form>
